...
const DATA_VERSION = '2'; // Incrementer pour forcer le rechargement des données
...
export class AppDataService {
    ...
    constructor(private storage: StorageService) {
        // Vérifier la version des données — si différente, vider le cache
        const storedVersion = this.storage.get<string>('data_version');
        if (storedVersion !== DATA_VERSION) {
            this.storage.clear();
            this.storage.set('data_version', DATA_VERSION);
        }
